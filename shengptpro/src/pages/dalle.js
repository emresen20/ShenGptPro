...
export default function Dalle({navigation}) {
    ...
    return (
        <SafeAreaView style={{ flex: 1, backgroundColor: "#dce1de" }}>
            ...
            <View style={styles.firstview}>
                <View style={{
                    flex: 1, marginLeft: 8, marginRight: 8, marginBottom: 20, backgroundColor: "white", borderColor: "gray",
