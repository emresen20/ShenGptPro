  ...
  return (
    ...
    <SafeAreaView style={{flex:1}}>
        <View style={{backgroundColor:"#606c38",height:hp(9),alignItems:"center",justifyContent:"space-around",flexDirection:"row",marginTop:32}}>
          <TouchableOpacity onPress={()=>navigation.navigate("Home")} style={{width:50,height:50}} >
              <MaterialIcons name="arrow-back" size={50} color={"#fefae0"} /> 
          </TouchableOpacity>
          
          <Image source={require("../images/shegpt.png")} style={{width: wp(15), height: hp(7), borderRadius: 20,marginLeft:10}}/>
